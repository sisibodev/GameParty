...
export const CARD_LABEL: Record<string, string> = {
  ...
  cash_burn: '현금 소각',
  portfolio_snipe: '포트폴리오 저격',
  profit_steal: '수익 강탈',
  focused_snipe: '집중 저격',
  forced_invest: '집중 투자 강제',
  trade_freeze: '거래 정지',
  hand_swap: '손바꿈',
  trend: '등락 예보',
  detect: '카드 탐지',
...
export const CARD_DESC: Record<string, string> = {
  ...
  cash_burn: '대상 플레이어의 현금 50%를 라운드 결산 시 소각',
  portfolio_snipe: '대상 플레이어의 비중 1위 종목에 -20%p 적용',
  profit_steal: '대상 플레이어의 이번 라운드 수익 30%를 내가 흡수',
  focused_snipe: '대상 플레이어의 지정 종목에 -35%p 강한 하락 적용',
  forced_invest: '대상이 현금 75% 이상을 한 종목에 투자해야 함. 미이행 시 자동 집행',
  trade_freeze: '대상 플레이어가 이번 라운드 지정 종목 매매 불가',
  hand_swap: '대상 플레이어와 보유 현금 전액을 즉시 교환',
...
export const CARD_COLOR: Record<string, string> = {
  ...
  cash_burn: '#ff5722',
  portfolio_snipe: '#e91e63',
  profit_steal: '#9c27b0',
  focused_snipe: '#f44336',
  forced_invest: '#ff9800',
  trade_freeze: '#795548',
  hand_swap: '#00bcd4',
  trend: '#2196f3',
  detect: '#2196f3',
